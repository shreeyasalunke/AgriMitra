...
const SearchResult = () => {
  const { search, loading } = useSelector((store) => store.toolitem);
  ...
  if (loading) {
    return <p className="text-center py-6 text-lg">Loading...</p>;
  }
  if (!search || search.length === 0) {
    return <p className="text-center py-6 text-gray-500">No results found.</p>;
  }
